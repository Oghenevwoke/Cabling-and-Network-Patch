...
Based on these findings, it was determined that the hard drive needs to be returned to MOD for re-staging. A new hard drive with the same computer name and proper staging is required.
